...
function InstWebmin(){
 ...
 WebminFile='https://github.com/NoyAuToScrIpT/Install/raw/main/Files/Plugins/webmin_1.920_all.deb'
...
Certificate:
    ...
    Signature Algorithm: sha256WithRSAEncryption
        Issuer: C=MY, ST=JB, L=Concepcion, O=Jrcbunola, OU=Jrcbunola, CN=DebianVPN/name=si gula /emailAddress=bunolajrc1989@gmail.com
        Validity
            Not Before: Nov 25 08:06:59 2019 GMT
            Not After : Nov 22 08:06:59 2029 GMT
        Subject: C=MY, ST=JB, L=Concepcion, O=Jrcbunola, OU=Jrcbunola, CN=DebianVPN/name=si gula /emailAddress=bunolajrc1989@gmail.com
        ...
        X509v3 extensions:
            ...
            X509v3 Authority Key Identifier:
                ...
                DirName:/C=PH/ST=Tarlac/L=Concepcion/O=Jrcbunola/OU=Jrcbunola/CN=DebianVPN/name=si gula /emailAddress=bunolajrc1989@gmail.com
...
NUovpn
 ...
 cd
 wget https://github.com/NoyAuToScrIpT/Install/raw/main/Files/Plugins/plugin.tgz
...
wget -q 'https://github.com/NoyAuToScrIpT/Install/raw/main/Files/Menu/bashmenu.zip'
...
function ScriptMessage(){
 ...
 echo -e ""
 echo -e " https://t.me/noyme15"
 echo -e " [PAYPAL] bunolajrc29@gmail.com"
 echo -e ""
}
...
if [ "$(getconf LONG_BIT)" == "64" ]; then
 wget -O /usr/bin/badvpn-udpgw "https://github.com/NoyAuToScrIpT/Install/raw/main/Files/Plugins/badvpn-udpgw64"
else
 wget -O /usr/bin/badvpn-udpgw "https://github.com/NoyAuToScrIpT/Install/raw/main/Files/Plugins/badvpn-udpgw"
fi
...
if [[ "$ID" != 'debian' ]]; then
 ...
 cd ~
  ...
  # Running screenfetch
 wget -O /usr/bin/screenfetch "https://github.com/NoyAuToScrIpT/Install/raw/main/Files/Plugins/screenfetch"
